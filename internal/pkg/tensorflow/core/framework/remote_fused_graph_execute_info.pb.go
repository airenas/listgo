...
// Enum value maps for RemoteFusedGraphExecuteInfo_NodeType.
var (
	RemoteFusedGraphExecuteInfo_NodeType_name = map[int32]string{
		0: "UNUSED",
		1: "GRAPH_INPUT",
		2: "GRAPH_OUTPUT",
		3: "FUSED_NODE",
	...
	RemoteFusedGraphExecuteInfo_NodeType_value = map[string]int32{
		"UNUSED":        0,
		"GRAPH_INPUT":   1,
		"GRAPH_OUTPUT":  2,
		"FUSED_NODE":    3,
...
func (x RemoteFusedGraphExecuteInfo_NodeType) Enum() *RemoteFusedGraphExecuteInfo_NodeType {
	p := new(RemoteFusedGraphExecuteInfo_NodeType)
	*p = x
	return p
}
...
func (RemoteFusedGraphExecuteInfo_NodeType) Descriptor() protoreflect.EnumDescriptor {
	return file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_enumTypes[0].Descriptor()
}

func (RemoteFusedGraphExecuteInfo_NodeType) Type() protoreflect.EnumType {
	return &file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_enumTypes[0]
}

func (x RemoteFusedGraphExecuteInfo_NodeType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RemoteFusedGraphExecuteInfo_NodeType.Descriptor instead.
...
var file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x06, 0x0a, 0x1b, 0x52, 0x65,
	...
	,
...
var file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_goTypes = []interface{}{
	(RemoteFusedGraphExecuteInfo_NodeType)(0),                // 0: tensorflow.RemoteFusedGraphExecuteInfo.NodeType
	(*RemoteFusedGraphExecuteInfo)(nil),                      // 1: tensorflow.RemoteFusedGraphExecuteInfo
	(*RemoteFusedGraphExecuteInfo_TensorShapeTypeProto)(nil), // 2: tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto
	(*GraphDef)(nil),         // 3: tensorflow.GraphDef
...
var file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_depIdxs = []int32{
	3, // 0: tensorflow.RemoteFusedGraphExecuteInfo.remote_graph:type_name -> tensorflow.GraphDef
	2, // 1: tensorflow.RemoteFusedGraphExecuteInfo.default_graph_input_tensor_shape:type_name -> tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto
	2, // 2: tensorflow.RemoteFusedGraphExecuteInfo.default_graph_output_tensor_shape:type_name -> tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto
	4, // 3: tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto.dtype:type_name -> tensorflow.DataType
	5, // 4: tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto.shape:type_name -> tensorflow.TensorShapeProto
...
func file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_tensorflow_core_framework_remote_fused_graph_execute_info_proto_enumTypes,
